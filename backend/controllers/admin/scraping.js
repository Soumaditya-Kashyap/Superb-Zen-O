/**
 * Scraping Controller
 * Handles movie scraping operations
 */

const MovieScraper = require('../../utils/movieScraper');

/**
 * Scrape all genres
 * POST /api/admin/scrape/genres
 */
 ...
 * POST /api/admin/scrape/languages
 */
 ...
 * POST /api/admin/scrape/genre/:genre
 */
